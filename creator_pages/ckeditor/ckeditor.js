            ...
            arrayToList: function (G, H, I, J, K) {
                ...
                while (1) {
                    ...
                    if (T.indent == P) {
                        ...
                        if (Q.type == 1)
                            if (T.grandparent.getDirection(1) != R) Q.setAttribute('dir', R);
        ...
        function s(C) {
            ...
            for (var M = E.length - 1; M >= 0; M--) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    var N, O;
                    if (G)
                        while ((N = I.getCommonAncestor(0, 1)) && (O = f[N.getName()]) && !(O && O[F])) {
    ...
    (function () {
        ...
        function q(S, T) {
            ...
            for (var V = 0, W = U.length; V < W; V++) {
                var X = new h(U[V]);
                if (X.getAttribute('type').toLowerCase() == 'text')
                    if (T) {
        ...
        a.dialog = function (S, T) {
            ...
            if (S._.removeDialogTabs && (ab = S._.removeDialogTabs[T]))
                for (i = 0; i < ab.length; i++) U.removeContents(ab[i]);
                ...
                if (S.config.dialog_startupFocusTab && af._.pageCount > 1) {
                    ...
                    if (av._.editor.mode == 'wysiwyg' && c) {
                        var as = S.document.$.selection,
                            at = as.createRange();
                        if (at)
                            if (at.parentElement && at.parentElement().ownerDocument == S.document.$ || at.item && at.item(0).ownerDocument == S.document.$) {
        ...
        a.dialog.prototype = {
            ...
            foreach: function (S) {
                ...
                for (var T in V._.contents)
                    for (var U in V._.contents[T]) S.call(V, V._.contents[T][U]);
                return V;
            },
            reset: (function () {
                var S = function (T) {
                    ...
                    if (z) {
                        ...
                        for (var C = 0; C < B.length; C++) {
                            ...
                            var G = D.startContainer,
                                ...
                                K = D.clone();
                            if (G && G.type == 3)
                                if (I >= G.getLength()) K.setStartAfter(G);
                                else K.setStartBefore(G);
                            if (H && H.type == 3)
                                if (!J) K.setEndBefore(H);
